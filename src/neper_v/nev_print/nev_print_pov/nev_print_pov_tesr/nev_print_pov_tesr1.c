...
#include"nev_print_pov_tesr_.h"

void
nev_print_pov_tesr (FILE * file, struct PRINT Print, struct TESR Tesr,
		struct TESRDATA TesrData)
{
  ...
  if (dim == 1)
  {
    ...
    nev_print_pov_mesh_3d (file, Print, Nodes, Mesh, NodeData, MeshData, &tmp);
