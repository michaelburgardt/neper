...
void
nev_print_pov_mesh_3d (FILE * file, struct PRINT Print, struct NODES Nodes,
		   struct MESH *Mesh,
		   ...
		   int ***pprintelt3dface)
{
  ...
  nev_print_pov_mesh_3d_compress (Print, Nodes, Mesh[3],
  ...
  nev_print_pov_mesh_3d_print (file, Print, N, M1D, M2D,
